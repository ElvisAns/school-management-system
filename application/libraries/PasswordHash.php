...
class PasswordHash {
	...
	{
		$output = '';
		if (is_readable('/htdocs/dev/urandom') && //add htdocs prefix for site who's root is in a subfolder, otherwise remove it away in the paths
		    ($fh = @fopen('/htdocs/dev/urandom', 'rb'))) {
