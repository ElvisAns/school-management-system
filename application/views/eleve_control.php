            ...
            <div class="mdc-layout-grid__inner">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-2 bg-light">
                  <h6 class="card-title card-padding pb-0" style="color: blue;">Liste des élèves inscrits et actifs</h6>
                    ...
                    <table class="table table-striped">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center">Telephone parents</th>
                          <th class="text-center">Email parents</th>
                          <th></th>
                        </tr>
                      </thead>
                      <tbody>
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-2 bg-light" style="border-style: solid;border-color: red;">
                  <h6 class="card-title card-padding pb-0" style="color:red;">Liste des élèves exclus et desactivés</h6>
                  <div class="table-responsive">
                    <table class="table table-striped">
                      <thead>
                         <tr>
