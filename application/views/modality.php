  ...
  <div class="body-wrapper">
    ...
    <aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
      ...
      <div class="mdc-drawer__content">
        ...
        {menu}
        <div class="profile-actions"> <a href="javascript:;">Parametres</a> <span class="divider"></span> <a href="javascript:;">Deconnecter</a> </div>
      </div>
    </aside>
    <!-- partial -->
              ...
              <div class="mdc-menu mdc-menu-surface" tabindex="-1">
                <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
                  ...
                  <li class="mdc-list-item" role="menuitem">
                    ...
                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
                      <h6 class="item-subject font-weight-normal">Deconnecter</h6> </div>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card">
                  <div class="d-flex justify-content-between">
                    <h3 class="card-title mb-2">CONFIGUREZ LES MODALITES DU PAYMENT</h3> </div>
                  <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4 mdc-layout-grid__cell--span-8-tablet">
                    <?=form_open_multipart('dashboard/modalities/', '', array("action"=>"config_mod"));?>
                      <div class="mdc-layout-grid__inner">
                        <div class="mdc-layout-grid__cell--span-12">
                          <div class="mdc-card">
                            <h6 class="card-title">TOTALITE DES FRAIS ET  CRITERES D'ACCES</h6>
                                    ...
                                    <table class="myTable table table-striped">
                                      <thead>
                                        <tr>
                                          ...
                                          <th class="text-center">Minerval ($)</th>
                                          <th class="text-center">Frais de Construction ($)</th>
                                          <th class="text-center">Bibliotheque ($)</th>
                                          <th class="text-center">Transport ($)</th>
                                          <th class="text-center">Quantine ($)</th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                        {entry_modality}
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-2-desktop">
                          <button type="submit" class="mdc-button mdc-button--raised filled-button--success"> 
                            <i class="material-icons mdc-button__icon">add_task</i> Enregister </button>
                        </div>
                        
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-2-desktop">
                          <button type="reset" class="mdc-button mdc-button--raised filled-button--secondary"> <i class="material-icons mdc-button__icon">add_tasks</i> Reinitialiser </button>
                        </div>
                      </div>
                    </form>
                  </div>
